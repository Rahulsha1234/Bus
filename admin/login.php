            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" autocomplete="off">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="login_input" id="login_input" class="form-control form-control-swift border-start-0" placeholder="Username or Email" style="border-radius: 0 12px 12px 0;" required>
                    </div>
                </div>
