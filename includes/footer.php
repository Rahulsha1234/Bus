    ...
    <footer class="footer-swift mt-auto" style="border-radius: 2.5rem 2.5rem 0 0; padding: 4.5rem 0 2.5rem 0; box-shadow: 0 -15px 30px rgba(0, 0, 0, 0.02);">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    ...
                    <div class="d-flex gap-2">
                        <a href="#" class="social-btn d-flex align-items-center justify-content-center rounded-circle" style="width: 36px; height: 36px; background: rgba(0,0,0,0.03); border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
            ...
            <hr class="my-4" style="border-color: var(--border-glass);">
