...
<div class="row align-items-center mb-5 mt-4 py-4">
    <div class="col-lg-7 text-center text-lg-start mb-5 mb-lg-0">
        ...
        <p class="lead text-secondary mb-4" style="max-width: 600px;">
            Book tickets across the largest network of premium luxury AC sleepers, seaters, and semi-sleepers. Zero
            booking fees, secure payments, and instant seat confirmation.
        </p>
    ...
    <div class="col-lg-5 text-center">
        <div class="position-relative d-inline-block">
            <div class="glass-card p-5 d-flex align-items-center justify-content-center"
                style="width: 320px; height: 320px; border-radius: 50%; background: linear-gradient(135deg, rgba(99,102,241,0.15) 0%, rgba(236,72,153,0.15) 100%);">
                <i class="fa-solid fa-bus-simple text-gradient-purple"
                    style="font-size: 8rem; filter: drop-shadow(0 15px 25px rgba(99,102,241,0.4));"></i>
            </div>
            <!-- absolute indicators -->
            <div class="glass-card py-2 px-3 position-absolute top-10 start-0 d-flex align-items-center gap-2 small animate-bounce"
                style="border-radius: 30px; animation: float 3s ease-in-out infinite;">
                <i class="fa-solid fa-shield text-success"></i> Secure Booking
            </div>
            <div class="glass-card py-2 px-3 position-absolute bottom-10 end-0 d-flex align-items-center gap-2 small"
                style="border-radius: 30px; animation: float 4s ease-in-out infinite 1s;">
...
<div class="row justify-content-center mb-5">
    <div class="col-lg-11">
        <div class="glass-card p-5" style="border-radius: 24px; box-shadow: 0 30px 60px -15px rgba(0, 0, 0, 0.6);">
            <h3 class="fw-bold mb-4 text-white"><i class="fa-solid fa-magnifying-glass me-2 text-indigo"></i>Find Your
                Destination</h3>
            ...
            <form action="<?= BASE_URL ?>/search.php" method="GET" class="row g-4 align-items-end">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <select name="source" id="source" class="form-select form-control-swift border-start-0"
                ...
                <div class="col-md-1 text-center mb-2 d-none d-md-block">
                    <button type="button" id="swapCities" class="btn btn-secondary-glass p-3 rounded-circle"
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <select name="destination" id="destination"
                            class="form-select form-control-swift border-start-0" style="border-radius: 0 12px 12px 0;"
                            required disabled>
                            <option value="">Select Origin first...</option>
                        </select>
                    </div>
                    <div id="dest-loading" class="small text-muted mt-1" style="display:none;"><i
                            class="fa-solid fa-spinner fa-spin me-1"></i>Loading routes...</div>
                    <div id="dest-empty" class="small text-warning mt-1" style="display:none;"><i
                            class="fa-solid fa-triangle-exclamation me-1"></i>No routes from this origin yet.</div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="date" id="date" class="form-control form-control-swift border-start-0"
                            style="border-radius: 0 12px 12px 0;" min="<?= date('Y-m-d') ?>"
                ...
                <div class="col-md-2">
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary-gradient py-3 text-uppercase fw-bold"
                            style="letter-spacing: 0.5px;">Search Buses</button>
                    </div>
                </div>
